      ...
      builder: (context) => Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 12),
            _priceOption(context, 'Retail / Ecer', part.sellingPriceRetail, 'Retail', part, format),
            _priceOption(context, 'Bengkel', part.sellingPriceWorkshop, 'Bengkel', part, format),
            _priceOption(context, 'Sales', part.sellingPriceSales, 'Sales', part, format),
